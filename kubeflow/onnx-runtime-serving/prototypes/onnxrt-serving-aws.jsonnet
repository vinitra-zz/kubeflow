// @apiVersion 0.1
// @name io.ksonnet.pkg.onnxrt-serving-aws
...
// @optionalParam defaultCpuImage string ONNXRuntime/serving:1.8.0 The default model server image (cpu)
// @optionalParam defaultGpuImage string ONNXRuntime/serving:1.10.0-gpu The default model server image (gpu)
...
local base = onnxrtserving.new(env, params);
local onnxrtDeployment = base.onnxrtDeployment +
