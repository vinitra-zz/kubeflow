// @apiVersion 0.1
// @name io.ksonnet.pkg.onnxrt-serving-request-log
// @description onnxrt-serving with request logging
// @shortDescription onnxrt-serving with request logging
...
local image = "gcr.io/kubeflow-images-public/onnxrt-model-server-cpu:v20180327-995786ec";
local httpProxyImage = "gcr.io/kubeflow-images-public/onnxrt-model-server-http-proxy:v20180723";
local loggingImage = "gcr.io/kubeflow-images-public/onnxrt-model-server-request-logger:v20180723";
